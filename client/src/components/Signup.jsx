...
const SignupPage = (props) => {
  ...
  async function signup() {
    if(name == "" || email == "" || password == "" || cpassword == ""){
      ...
      if(cpassword == "")
      {        
        seterror_message('Please Fill your Confirm Password');
      }
      if(password == "")
      {        
        seterror_message('Please Fill your Password');
      }
      if(email == "")
      {        
        seterror_message('Please Fill your Email Address');
      }
      if(name == "")
      {        
        seterror_message('Please Fill your Name');
      }
      
    if(name == "" && email == "" && password == "" && cpassword == ""){
      seterror_message('Please Fill All Details');
    }

    }else{
      if(password != cpassword)
      {
        seterror_message('Password Doesn`t Match');
    ...
    <div className="Services">
      <form action="">
        <div className="font-weight-bold">
          <h2>Sign-Up Page for First Time Merchants</h2>
          <h6 className="text-danger">{error_message}</h6>
        </div>
